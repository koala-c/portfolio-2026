...
const translations = {
  en: {
    ...
    "projects.calendarFlair.description": "Archive comparing Google Calendar keyword illustrations",
    "projects.bookClub.title": "Book Club",
    "projects.bookClub.description": "Reading club with digital passes and QR attendance",
    ...
    "music.description": "Music has always been part of my life. Violin is my main instrument, and I also sing and play ukulele in modern and acoustic styles.",
    "music.latestRelease": "About My Music",
    "music.albumDescription": "I can pick up modern songs by ear and adapt them for events, content, and collaborations, performing each piece on violin or voice depending on the project.",
    "music.listenSpotify": "More coming soon",
    "music.trackHeader": "Piece",
    "music.durationHeader": "Style",
    "music.tracksNote": "No recordings available yet. Audio previews and full pieces coming soon.",
    "music.comingSoon": "Coming soon",
    "music.showPieces": "Show pieces",
    "music.hidePieces": "Hide pieces",
  ...
  es: {
    ...
    "projects.calendarFlair.description": "Archivo comparativo de ilustraciones de Google Calendar",
    "projects.bookClub.title": "Club del Libro",
    "projects.bookClub.description": "Club de lectura con pases digitales y asistencia por QR",
    ...
    "music.description": "La música siempre ha sido parte de mi vida. El violín es mi instrumento principal, y también canto y toco ukelele en estilos modernos y acústicos.",
    "music.latestRelease": "Sobre Mi Música",
    "music.albumDescription": "Puedo sacar de oído canciones modernas y adaptarlas para eventos, contenido y colaboraciones, interpretando cada pieza con violín o voz según el proyecto.",
    "music.listenSpotify": "Próximamente",
    "music.trackHeader": "Pieza",
    "music.durationHeader": "Estilo",
    "music.tracksNote": "Aún no hay grabaciones disponibles. Próximamente habrá avances de audio y piezas completas.",
    "music.comingSoon": "Próximamente",
    "music.showPieces": "Ver piezas",
    "music.hidePieces": "Ocultar piezas",
  ...
  cat: {
    ...
    "projects.calendarFlair.description": "Arxiu comparatiu d'il·lustracions de Google Calendar",
    "projects.bookClub.title": "Club del Llibre",
    "projects.bookClub.description": "Club de lectura amb passis digitals i assistència per QR",
    ...
    "music.description": "La música sempre ha estat part de la meva vida. El violí és el meu instrument principal, i també canto i toco l'ukelele en estils moderns i acústics.",
    "music.latestRelease": "Sobre La Meva Música",
    "music.albumDescription": "Puc treure d'oïda cançons modernes i adaptar-les per a esdeveniments, contingut i col·laboracions, interpretant cada peça amb violí o veu segons el projecte.",
    "music.listenSpotify": "Properament",
    "music.trackHeader": "Peça",
    "music.durationHeader": "Estil",
    "music.tracksNote": "Encara no hi ha gravacions disponibles. Properament hi haurà avanços d'àudio i peces completes.",
    "music.comingSoon": "Properament",
    "music.showPieces": "Veure peces",
    "music.hidePieces": "Ocultar peces",
  ...
  it: {
    ...
    "projects.calendarFlair.description": "Archivio comparativo di illustrazioni di Google Calendar",
    "projects.bookClub.title": "Club del Libro",
    "projects.bookClub.description": "Club di lettura con pass digitali e presenze tramite QR",
    ...
    "music.description": "La musica ha sempre fatto parte della mia vita. Il violino è il mio strumento principale, e canto e suono anche l'ukulele in stili moderni e acustici.",
    "music.latestRelease": "Sulla Mia Musica",
    "music.albumDescription": "Posso suonare a orecchio canzoni moderne e adattarle per eventi, contenuti e collaborazioni, interpretando ogni brano con violino o voce in base al progetto.",
    "music.listenSpotify": "Prossimamente",
    "music.trackHeader": "Brano",
    "music.durationHeader": "Stile",
    "music.tracksNote": "Al momento non ci sono registrazioni disponibili. Anteprime audio e brani completi in arrivo.",
    "music.comingSoon": "Prossimamente",
    "music.showPieces": "Mostra brani",
    "music.hidePieces": "Nascondi brani",
